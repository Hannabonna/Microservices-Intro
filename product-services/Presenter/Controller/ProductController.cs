...
using product_services.Application.UseCases.Product.Queries.GetProducts;
using product_services.Application.UseCases.Product.Command.CreateProduct;
using product_services.Application.UseCases.Product.Command.UpdateProduct;
using product_services.Application.UseCases.Product.Command.DeleteProduct;

namespace product_services.Presenter.Controller
{
    [ApiController]
    [Route("product")]
